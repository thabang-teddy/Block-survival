    ...
    */
    ...
    'pages' => [
        ...
        'paths' => [
            ...
            // the project keeps its single page in js/Pages (capital P); the default
            // 'js/pages' only matches on case-insensitive filesystems, so CI on Linux
            // failed the Inertia page-exists assertion
